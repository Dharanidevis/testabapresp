...
define view entity ZDD_EY_BOOKING as select from /dmo/booking_m
composition[0..*] of ZDD_EY_BOOKSUPPL as _BookingSupplement
association to parent ZZ_DD_EY_TRAVEL_ROOT as _Travel on
