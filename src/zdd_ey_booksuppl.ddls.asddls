...
define view entity ZDD_EY_BOOKSUPPL as select from /dmo/booksuppl_m
association to parent ZDD_EY_BOOKING as _Booking on
   $projection.BookingId = _Booking.BookingId and
   $projection.TravelId = _Booking.TravelId
association[1..1] to ZZ_DD_EY_TRAVEL_ROOT as _Travel on
